#!/usr/bin/env python3
"""
完整版Top 20评分脚本 - 基于历史K线的v22_engine评分
修复: high_20d不包含最新一天，突破检测才能生效
"""
...
print(f"\n成功评分 {len(results)} 只票")
print("=" * 80)
print("Top 20 完整版评分榜 (v22_engine 基于历史K线)")
print("=" * 80)
...
with open('/root/.openclaw/workspace/skills/ifind-momentum-screener/data/top20_full_v22.json', 'w') as f:
